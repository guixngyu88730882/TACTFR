...
//   Ped player = Function.Call<Ped>(Hash.GET_PLAYER_PED, Game.Player);
...
namespace GTA.Native
{
    public enum Hash : ulong
    {
        ...
        GET_CURRENT_TV_SHOW_PLAY_TIME = 0xDD3AA743AB7D4D75,
        ...
        PLAY_PED_AUDIO_EVENT_ANIM = 0xAD2191A6E3543189,
        ...
        _FORCE_VEHICLE_ENGINE_SYNTH = 0xEB7D0E1FCC8FE17A,
        ...
        _ENABLE_DRAG_RACE_STATIONARY_WARNING_SOUNDS = 0xBEFB80290414FD4F,
        ...
        SET_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE = 0xC9D623C5A3D8FD5D,
        REMOVE_PORTAL_SETTINGS_OVERRIDE = 0xB4BBFD9CD8B3922B,
        REMOVE_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE = 0x8EF105736194F80C,
        ...
        _INTERPOLATE_CAM_WITH_PARAMS = 0xDDA77EE33C005AAF,
        _ACTIVATE_CAM_WITH_INTERP_AND_FOV_CURVE = 0x34CFC4C2A38E83E3,
        ...
        _GET_THIRD_PERSON_CAM_MIN_ORBIT_DISTANCE_SPRING = 0xBC456FB703431785,
        _GET_THIRD_PERSON_CAM_MAX_ORBIT_DISTANCE_SPRING = 0xD4592A16D36673ED,
        ...
        GET_CUT_FILE_OFFSET = 0x1FA904B60E492336,
        ...
        GET_CUTSCENE_PLAY_TIME = 0x710286BC5EF4D6E1,
        ...
        _GET_LAST_ENTITY_HIT_BY_ENTITY = 0xA75EE4F689B85391,
        ...
        _SET_ENTITY_NO_COLLISION_WITH_NETWORKED_ENTITY = 0x0A27A7827347B3B1,
        ...
        _NETWORK_EXPECT_EXPLOSION_EVENTS_FOR_PLAYER = 0x5241DB47A8B8AD54,
        _GET_MAXIMUM_NUMBER_OF_WATER_CANNONS = 0x56581E7E219D6263,
        _GET_WATER_CANNON_COORDS = 0xE61CBD3ED80E7327,

        // GRAPHICS (401 natives)
        ...
        _SET_PARTICLE_FX_LOOPED_CAMERA_BIAS = 0x4100BF0346A8D2C3,
        ...
        _START_VEHICLE_PARTICLE_FX_LOOPED = 0xDF269BE2909E181A,
        ...
        _FORCE_ALLOW_SNOW_FOOT_VFX_ON_ICE = 0xA342A3763B3AFB6C,
        USE_SNOW_WHEEL_VFX_WHEN_UNSHELTERED = 0x4CC7F0FEA5283FE0,
        DISABLE_REGION_VFX = 0xEFD97FF47B745B8D,
        _FORCE_GROUND_SNOW_PASS = 0x6E9EF3A33C8899F8,
        ...
        _HAS_SCALEFORM_MOVIE_NAMED_LOADED = 0x9743BCCF7CD6E1F6,
        ...
        _SET_SCALEFORM_MOVIE_NAMED_AS_NO_LONGER_NEEDED = 0x2FDFB1B04C76E9C3,
        ...
        _SET_TV_CHANNEL_PLAYLIST_DIRTY = 0xEE831F15A8D0D94A,
        ...
        _USE_VEHICLE_TARGETING_RETICULE_ON_VEHICLES = 0x1BC0EA2912708625,
        ...
        SET_TEXT_LINE_HEIGHT_MULT = 0x9F4624F76E6953D1,
        ...
        _SHOW_PURCHASE_INSTRUCTIONAL_BUTTON = 0xF6865E26067B708C,
        ...
        GET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE = 0xF46851AB8B02EF40,
        SET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE = 0x3FFC556B62146F75,
        ...
        _SET_BLIP_GPS_ROUTE_DISPLAY_DISTANCE = 0x25D984CFB64ED6DE,
        ...
        _SET_PAUSE_EXTERIOR_RENDERING_WHILE_IN_INTERIOR = 0x35CCE12EAECB4A51,
        ...
        SET_MINIMAP_BACKGROUND_HIDDEN = 0xB09D42557C45EBA1,
        ...
        IS_HUD_COMPONENT_HIDDEN_THIS_FRAME = 0x8EDC335C943465C8,
        ...
        _IS_XBOXPC_VERSION = 0xE2BCD0EFAE90D1F4,
        ...
        _SET_CONTENT_PROP_TYPE = 0xBA4583AF4C678A9B,
        _GET_CONTENT_PROP_TYPE = 0x8BAF8AD59F47AAFC,
        ...
        _NETWORK_SPEND_BUY_MFGARAGE = 0xA2ED36DCF0FCA413,
        _NETWORK_SPEND_UPGRADE_MFGARAGE = 0xCF8F346DDDC66643,
        _NETWORK_SPEND_BUY_SUPPLIES = 0xB48185C0CA67B16B,
        _NETWORK_SPEND_BUY_ACID_LAB = 0xF1E26A7924327152,
        _NETWORK_SPEND_UPGRADE_ACID_LAB_EQUIPMENT = 0x110EE9D486C23126,
        _NETWORK_SPEND_UPGRADE_ACID_LAB_ARMOR = 0xA7D541C9ACD63133,
        _NETWORK_SPEND_UPGRADE_ACID_LAB_SCOOP = 0x2940558E05BCC2EC,
        _NETWORK_SPEND_UPGRADE_ACID_LAB_MINES = 0x4B99AB08C92C54E4,
        _NETWORK_SPEND_RENAME_ACID_LAB = 0x842B1C5AF61ACDE9,
        _NETWORK_SPEND_RENAME_ACID_PRODUCT = 0x446798F7495DD7D8,
        _NETWORK_EARN_AWARD_JUGGALO_MISSION = 0xDDF047577F1A02A7,
        _NETWORK_EARN_AWARD_ACID_LAB = 0xD1A8165767AD2D23,
        _NETWORK_EARN_AWARD_DAILY_STASH = 0xC30650FA74A19D02,
        _NETWORK_EARN_AWARD_DEAD_DROP = 0xD01EBAEA1F905EF6,
        _NETWORK_EARN_AWARD_RANDOM_EVENT = 0xBEAFBB1B98B7EF55,
        _NETWORK_EARN_AWARD_TAXI = 0xA914768AD35CD3A5,
        _NETWORK_EARN_STREET_DEALER = 0xA81017EE1324FDFE,
        _NETWORK_EARN_SELL_ACID = 0x79B656937DF6DF5D,
        _NETWORK_EARN_SETUP_PARTICIPATION_ACID_LAB = 0xE3942D59E8A7F70D,
        _NETWORK_EARN_SOURCE_PARTICIPATION_ACID_LAB = 0x136F11B5DF1B304D,
        _NETWORK_EARN_SELL_PARTICIPATION_ACID_LAB = 0xCA3EF9B09A8D76B4,
        _NETWORK_EARN_JUGGALO_STORY_MISSION = 0xE01D10BA8CD53621,
        _NETWORK_EARN_JUGGALO_STORY_MISSION_PARTICIPATION = 0x40FF6CCCC476185C,
        _NETWORK_EARN_FOOLIGAN_JOB = 0xCE4452AE85F5E252,
        _NETWORK_EARN_FOOLIGAN_JOB_PARTICIPATION = 0xC376B92D0E060970,
        _NETWORK_EARN_TAXI_JOB = 0x991E1588FAD9019D,
        _NETWORK_EARN_DAILY_STASH_HOUSE_COMPLETED = 0xCABC9874AFA70D6D,
        _NETWORK_EARN_DAILY_STASH_HOUSE_PARTICIPATION = 0x9C0C6BD0F94CE391,
        _NETWORK_EARN_AVENGER = 0x55F006B9D4A46C1D,
        _NETWORK_EARN_SMUGGLER_OPS = 0xDEA273D5F8A9661A,
        _NETWORK_EARN_BONUS_OBJECTIVE = 0xDCEF983C24191997,
        _NETWORK_EARN_PROGRESS_HUB = 0xF8332B06F0EECC9C,
        _NETWORK_SPENT_AIR_FREIGHT = 0x8C7E8D6F96C9E948,
        _NETWORK_SPENT_SKIP_CARGO_SOURCE_SETUP = 0xED1B407BADA42CEC,
        _NETWORK_SPENT_STEALTH_MODULE = 0x95CE79A6939C537A,
        _NETWORK_SPENT_MISSILE_JAMMER = 0xD687100F616163F4,
        _NETWORK_SPENT_GENERIC = 0x2803B027479FB640,
        _NETWORK_EARN_GENERIC = 0xBF7B5BB7ED890380,
        _NETWORK_CLEAR_TRANSACTION_TELEMETRY_NONCE = 0xE03B9F95556E48E9,
        ...
        NET_GAMESERVER_CHECKOUT_PENDING = 0x4B64CD6D18474126,
        ...
        _NETWORK_MULTIPLAYER_CROSSPLAY_NOT_ALLOWED = 0xA6BC0D9BCF9662FA,
        ...
        _NETWORK_HAVE_PLATFORM_COMMUNICATION_PRIVILEGES = 0xE1E02509169C124E,
        ...
        NETWORK_CHECK_CAN_ACCESS_AND_ALERT = 0x6FA9825D0B5A721B,
        _NETWORK_GET_ACCESS_CODE_LABEL_HEADING = 0x967E6FB554E1B6DE,
        _NETWORK_GET_ACCESS_CODE_LABEL_BODY = 0x214CA1730793EBA8,
        ...
        _NETWORK_SESSION_LEAVE_INCLUDING_REASON = 0xE0128328CF1FD9F4,
        ...
        NETWORK_SESSION_GET_UNIQUE_CREW_LIMIT = 0xCDC936BF35EDCB73,
        ...
        _NETWORK_INVITE_GET_JOIN_FAIL_REASON = 0x7B335F84501145BB,
        _NETWORK_INVITE_CLEAR_JOIN_FAIL_REASON = 0x8EF5F5811A940F82,
        ...
        _NETWORK_IS_AMERICAS_VERSION = 0x0292BD7F3766CEBC,
        ...
        _NETWORK_GET_RANDOM_FLOAT_RANGED = 0x04BD27B5ACB67067,
        ...
        _NETWORK_GET_HOST_BROADCAST_DATA_SIZE_UNSYNCED = 0x72C8588ABE22C972,
        _NETWORK_GET_PLAYER_BROADCAST_DATA_SIZE_UNSYNCED = 0xB99CD664FD4720A1,
        _NETWORK_GET_BROADCAST_DATA_HOST_UPDATE_SIZE = 0xE448693B3EA3B92C,
        _NETWORK_GET_BROADCAST_DATA_PLAYER_UPDATE_SIZE = 0xAC3F722321800755,
        ...
        NETWORK_GET_HOST_OF_THREAD = 0xD3DEBE2991FE8098,
        ...
        _NETWORK_LOAD_GAMER_DISPLAY_NAME = 0x338ECE3637937BC2,
        ...
        _NETWORK_DOES_COMMUNICATION_GROUP_HAVE_PERMISSION = 0xDBDF80673BBA3D65,
        _NETWORK_DOES_COMMUNICATION_GROUP_HAVE_SETTINGS_ENABLED = 0x20C12650830A64EC,
        _NETWORK_GET_COMMUNICATION_GROUP_FLAGS = 0x40DF02F371F40883,
        _NETWORK_GET_COMMUNICATION_GROUP_DEFAULT_FLAGS = 0x97F35B898D2D067F,
        _NETWORK_GET_COMMUNICATION_GROUP_VALUE = 0xBF66ACD9AE81A99F,
        _NETWORK_SET_COMMUNICATION_GROUP_FLAGS = 0xE549F846DE7D32D5,
        _NETWORK_HAS_PLAYER_PASSED_CHECK_TYPE = 0x62E29CDA11F9C230,
        ...
        _NETWORK_CAN_TEXT_FROM_GAMER_BE_VIEWED = 0x9F633448E4C73207,
        ...
        _NETWORK_SET_TUTORIAL_SPECIAL_SESSION = 0x35AEB4AC7C73C6E1,
        _NETWORK_IS_SPECIAL_TUTORIAL_SESSION = 0x4666CD7431DE98E2,
        ...
        _NETWORK_HIDE_ENTITY_IN_TUTORIAL_SESSION = 0xCFE359CCCFE359CC,
        ...
        _SET_FREEMODE_REPORT_DATA = 0x527803286A8B6C81,
        IS_OBJECT_REASSIGNMENT_IN_PROGRESS = 0x28123C8B056CC8AA,
        ...
        _NETWORK_CLEAR_CLOCK_SYNC_TIME_OVERRIDE = 0x0C1BF187985B15C8,
        NETWORK_SYNC_CLOCK_TIME_OVERRIDE = 0xCBD02360C5E16871,
        ...
        _NETWORK_SET_TUNABLES_REGISTRATION_CONTEXTS = 0x014A73449675121D,
        _NETWORK_CLEAR_TUNABLES_REGISTRATION_CONTEXTS = 0x0C87C83C8950432B,
        _NETWORK_GET_TUNABLES_REGISTRATION_BOOL = 0xB327CF1B8C2C0EA3,
        _NETWORK_GET_TUNABLES_REGISTRATION_INT = 0x0D94071E55F4C9CE,
        _NETWORK_GET_TUNABLES_REGISTRATION_FLOAT = 0x367E5E33E7F0DD1A,
        ...
        _NETWORK_TRIGGER_DAMAGE_EVENT_FOR_ZERO_PED_DAMAGE = 0xE9D0244ACBEE1BC4,
        ...
        _NETWORK_SET_IGNORE_VEHICLE_RAMMED_BY_NON_VEHICLE = 0x67F7C81C1395672A,
        ...
        UGC_GET_CONTENT_DESCRIPTION = 0x4A56710BAB5C4DB4,
        ...
        UGC_HAS_PERMISSION_TO_WRITE = 0xC33E7CBC06EC1A8D,
        ...
        _NETWORK_HAS_ROS_PRIVILEGE_MP_TEXT_COMMUNICATION = 0xD9719341663C385F,
        _NETWORK_HAS_ROS_PRIVILEGE_MP_VOICE_COMMUNICATION = 0x8956A309BE90057C,
        _NETWORK_HAS_ROS_PRIVILEGE_REPORTING = 0x9BA54B3CFB82ADDD,
        ...
        _NETWORK_GET_DUMP_OF_ASSET_VERIFIER = 0x69D05E1EAD74B9DD,
        ...
        NETWORK_HAS_SC_MEMBERSHIP = 0xAB286B2192A71E32,
        NETWORK_UGC_NAV = 0xC1447451DDB512F0,
        _NETWORK_GET_GAME_RESTART_REASON = 0x7F7E8401F81CB65B,
        _NETWORK_CONFIRM_GAME_RESTART = 0x0A141818CA2311AD,
        _NETWORK_GET_GAME_RESTART_REASON_MESSAGE_LABEL = 0x47B11D51FC50A259,
        _NETWORK_GET_BATTLEYE_ERROR_MESSAGE_LABEL = 0xCBA50F371E45B90D,
        ...
        _SET_OBJECT_TARGETTABLE_BY_PLAYER = 0xB39F03368DB0CAA2,
        ...
        DOOR_SYSTEM_GET_IS_SPRING_REMOVED = 0x8562FD8AB1E94D39,
        ...
        _SET_PICKUP_GLOW_DISABLED = 0x08BD8BA5BDE2C2FA,
        ...
        _IS_CONTROL_HELD_DOWN = 0xE9CB8C56E90D5079,
        ...
        _GET_GAMEPAD_TYPE = 0x18E474F40EF05F10,
        ...
        _SET_BLOCK_AMBIENT_PEDS_FROM_DROPPING_WEAPONS_THIS_FRAME = 0xC73EFFC5E043A8BA,
        ...
        _HAS_PED_CLEAR_LOS_TO_ENTITY = 0xA32ABFEB2A03B306,
        ...
        _SET_PED_SURVIVES_BEING_OUT_OF_WATER = 0x100CD221F572F6E1,
        ...
        SET_PED_CAN_BODY_RECOIL_IK = 0xE84EC1735FB39663,
        ...
        GET_DAMPING = 0x8C520A929415BCD2,
        ...
        GET_PLAYER_TARGETING_MODE = 0x875BDD898B99C8CE,
        ...
        _SEND_TU_SCRIPT_EVENT_NEW = 0x71A6F836422FDD2B,
        ...
        _SC_EMAIL_MARKETING_EMAIL_OPENED = 0x69AA35F3F391CDBA,
        ...
        SC_PROFANITY_GET_PROFANE_WORD = 0x75CC8931A11128C9,
        ...
        _GET_STAT_HASH_FOR_CHARACTER_STAT = 0xD69CE161FE614531,
        ...
        _PLAYSTATS_FLOW_LOW = 0xE6A27CDA42887F93,
        _PLAYSTATS_FLOW_MEDIUM = 0xC4493521BAA12CCE,
        _PLAYSTATS_FLOW_HIGH = 0xCFB0E9C3456319EA,
        ...
        _PLAYSTATS_SHOPMENU_NAV = 0xF96E9EA876D9DC92,
        ...
        _PLAYSTATS_NAMED_USER_CONTENT = 0xAA434D7D0A89A95C,
        ...
        _PLAYSTATS_DEATH_INFO = 0x01D8B04D02F1217F,
        ...
        _PLAYSTATS_INIT_MULTIPLAYER = 0x7E5EED10B11CEDBA,
        ...
        _PLAYSTATS_ACID_MISSION_END = 0x8A23D1324F6B2BAC,
        _PLAYSTATS_ACID_RND = 0xCEACCF0550FDC5BA,
        _PLAYSTATS_IDLE = 0xEC9553A178E8F1D1,
        _PLAYSTATS_PLAYER_STYLE = 0x48FAC5DC7AC6EA99,
        _PLAYSTATS_RANDOM_EVENT = 0x7EA06F970F999394,
        _PLAYSTATS_ALERT = 0x5649CA22AF74E019,
        _PLAYSTATS_ATTRITION_STAGE_END = 0xBD642335A732F1A8,
        _PLAYSTATS_SHOWROOM_NAV = 0x961D4157B9B428DB,
        _PLAYSTATS_SHOWROOM_OVERVIEW = 0x151D6C04C9E2742F,
        _PLAYSTATS_PIMENU_NAV = 0xE6D323A5E9EFFB76,
        _PLAYSTATS_RECOVER_VEHICLE = 0xBEB0D930B3CCE4D5,
        _PLAYSTATS_SCRIPT_EVENT_FPOM = 0x574A7808450E141C,
        _PLAYSTATS_LOBBY_EXIT = 0x4649D80CE1A35BA1,
        _PLAYSTATS_LOBBY_STARTED = 0xDC00BB9C27347A8F,
        _PLAYSTATS_CREATOR_END = 0x72289B8C78B02962,

        // STREAMING (123 natives)
        ...
        _GET_MODEL_ADDITIONAL_COST = 0x0F7082C60FB479EF,
        _GET_TOTAL_MODEL_COST = 0x4A91423C04BAADA1,
        SET_ISLAND_ENABLED = 0x9A9D1BA639675CF1,
        _SET_SPHERICAL_STREAM_DISTANT_HILODS_THIS_FRAME = 0x68F1C25420D5F6AA,
        ...
        TASK_SHARK_CIRCLE_COORD = 0x60A19CF85FF4CEFA,
        ...
        SET_SEQUENCE_PREVENT_MIGRATION = 0xF5D1F489147CB683,
        ...
        CLEAR_PED_SCRIPT_TASK_IF_RUNNING_THREAT_RESPONSE_NON_TEMP_TASK = 0xF6DC48E56BE1243A,
        ...
        SET_PED_WAYPOINT_PROGRESS = 0x686ECCD99D4E61BB,
        ...
        VEHICLE_WAYPOINT_PLAYBACK_GET_IS_PAUSED = 0xE435D3539EFDCD1B,
        ...
        _SET_SCRIPT_TASK_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED = 0x32F6EEF031F943DC,
        _SET_AMBIENT_PED_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED = 0x0EFE4834A2F40563,
        ...
        _GET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED = 0x613A431BCD5A22EB,
        ...
        _SET_VEHICLE_MAX_LAUNCH_ENGINE_REVS = 0x5AE614ECA5FDD423,
        _GET_VEHICLE_THROTTLE = 0x92D96892FC06AF22,
        ...
        _SET_BOUNDS_AFFECT_WATER_PROBES = 0x85FC953F6C6CBDE1,
        ...
        _SET_PLANE_AVOIDS_OTHERS = 0xBAFB99B304BC52A7,
        ...
        _SET_MAKE_TRAIN_SCAN_FOR_BLOCKING_ENTITIES = 0x559B6073DB7FFFF9,
        _GET_MISSION_TRAIN_CONFIG_INDEX_BY_NAME = 0x7DFAD92A34F09C00,
        ...
        _GET_VEHICLE_MODEL_NUM_DRIVE_GEARS = 0x61F02E4E9A7A61EA,
        _GET_VEHICLE_MAX_DRIVE_GEAR_COUNT = 0x24910C3D66BA770D,
        _GET_IS_VEHICLE_ELECTRIC = 0x1FCB07FE230B6639,
        _GET_VEHICLE_DRIVETRAIN_TYPE = 0x1423725069EE1D14,
        _GET_VEHICLE_CURRENT_DRIVE_GEAR = 0x56185A25D45A0DCD,
        _GET_VEHICLE_CURRENT_REV_RATIO = 0xF9DDA40BC293A61E,
        ...
        _SET_ATTACHED_VEHICLE_TO_TOW_TRUCK_ARM = 0x48BD57D0DD17786A,
        ...
        _GET_VEHICLE_TRAILER_PARENT_VEHICLE = 0x80D9D32636369C92,
        SET_VEHICLE_USES_LARGE_REAR_RAMP = 0xCAC66558B944DA67,
        SET_VEHICLE_RUDDER_BROKEN = 0x09606148B6C71DEF,
        SET_VEHICLE_TAIL_BROKEN = 0x6CB5B84B78AC55FE,
        ...
        _SET_TRANSMISSION_REDUCED_GEAR_RATIO = 0x337EF33DA3DDB990,
        _GET_VEHICLE_DESIRED_DRIVE_GEAR = 0xFD8CE53356B5D745,
        ...
        _SET_VEHICLE_EXPLOSIVE_DAMAGE_SCALE = 0x84D7FFD223CAAFFD,
        ...
        _SET_VEHICLE_USE_HORN_BUTTON_FOR_NITROUS = 0x1980F68872CC2C3D,
        ...
        _SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_RECEIVED_BY_AI_VEHICLE = 0xB0B7DF5CB876FF5E,
        ...
        SET_PLANE_CONTROL_SECTIONS_SHOULD_BREAK_OFF_FROM_EXPLOSIONS = 0xDD8A2D3337F04196,
        ...
        _SET_DEPLOY_MISSILE_BAYS = 0x0C02468829E4AA65,
        _ARE_MISSILE_BAYS_DEPLOYED = 0xEA4743874D515F13,
        ...
        _IS_VEHICLE_ON_BOOST_PAD = 0x71C6302CBCA6CA35,
        ...
        _SET_NITROUS_IS_VISIBLE = 0x465EEA70AF251045,
        _SET_OVERRIDE_TRACTION_LOSS_MULTIPLIER = 0xAFD262ACCA64479A,
        _SET_DRIFT_SLIP_ANGLE_LIMITS = 0xDAF4C98C18AC6F06,
        _SET_MINIMUM_TIME_BETWEEN_GEAR_SHIFTS = 0x16CFBC5E7EB32861,
        FULLY_CHARGE_NITROUS = 0x1A2BCC8C636F9226,
        _SET_REMAINING_NITROUS_DURATION = 0x1AD0F63A94E10EFF,
        _GET_REMAINING_NITROUS_DURATION = 0xBEC4B8653462450E,
        IS_NITROUS_ACTIVE = 0x491E822B2C464FE4,
        CLEAR_NITROUS = 0xC889AE921400E1ED,
        SET_NITROUS_IS_ACTIVE = 0x9E566EA551F4F1A6,
        ...
        APPLY_EMP_EFFECT = 0x249249D74F813EB2,
        ...
        _SET_ALLOW_COLLISION_WHEN_IN_VEHICLE = 0x27D27223E8EF22ED,
        _IS_VEHICLE_GEN9_EXCLUSIVE_MODEL = 0x6638C0F19DE692FE,
        ...
        _GET_TIME_BEFORE_VEHICLE_WEAPON_RELOAD_FINISHES = 0xC8C6F4B1CDEB40EF,
        _HAS_WEAPON_RELOADING_IN_VEHICLE = 0x8062F07153F4446F,
        _GET_VEHICLE_WEAPON_RELOAD_TIME = 0xD0AD348FFD7A6868,
        _GET_AMMO_IN_VEHICLE_WEAPON_CLIP = 0x2857938C5D407AFA,
        GET_AMMO_IN_CLIP = 0x2E1202248937775C,
        _SET_AMMO_IN_VEHICLE_WEAPON_CLIP = 0x873906720EE842C3,
        ...
        _TRIGGER_VEHICLE_WEAPON_RELOAD = 0x5B1513F27F279A44,
        ...
        _SET_WEAPON_PED_DAMAGE_MODIFIER = 0x1091922715B68DF0,
